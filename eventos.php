...
<html lang="es">
    ...
    <head>
        ...
        <!-- CANONICAL -->
	    <link rel="canonical" href="https://www.saxofonista.cat/eventos.php">

        <!-- COMMON-LOCALIZATION -->
        <?php include "common-php/localization/main.html"; ?>
        <!-- /COMMON-LOCALIZATION -->

        <title>Saxofonista para eventos | Contratar Saxo Profesional | SAXCAT</title>

        <meta name="description" content="Saxofonista para eventos, contrat y música en directo para tu evento. Solista, DJ y Saxo o en Grupo de música.">
        <meta name="keywords" content="eventos, saxofonista, dj y saxo, grupo de música, contratar, barcelona, madrid">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 p-0 text">
                        <div class="row intro m-0">
                            <div class="col-12">
                                <span class="pre-title m-0">Saxofonista para eventos</span>
                                <div class="title-icon">                                    
                                    <h2><span class="featured"><span><i class="icon icon-globe-alt"></i>Eventos</span></span> Cocktail</h2>
                                </div>
                            </div>
                        </div>
        ...
        <!-- EVENTS-MODA&FASHION -->
        <section id="fashion" class="section-1 single">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 p-0 text">
                        <div class="row intro m-0">
                            <div class="col-12">
                                <span class="pre-title m-0">Saxofonista para eventos</span>
                                <div class="title-icon">                                    
                                    <h2><span class="featured"><span><i class="icon icon-globe-alt"></i>Moda</span></span> & Fashion</h2>
                                </div>
                            </div>
                        </div>
        ...
        <!-- EVENTS-DJ&SAX -->
        <section id="djsax" class="section-1 single">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 p-0 text">
                        <div class="row intro m-0">
                            <div class="col-12">
                                <span class="pre-title m-0">Saxofonista para eventos</span>
                                <div class="title-icon">                                    
                                    <h2><span class="featured"><span><i class="icon icon-globe-alt"></i>DJ</span></span> & SAXO</h2>
                                </div>
                            </div>
                        </div>
        ...
        <!-- EVENTS-JAZZ -->
        <section id="jazz" class="section-1 single">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 p-0 text">
                        <div class="row intro m-0">
                            <div class="col-12">
                                <span class="pre-title m-0">Saxofonista para eventos</span>
                                <div class="title-icon">                                    
                                    <h2><span class="featured"><span><i class="icon icon-globe-alt"></i>Saxo</span></span> Jazz</h2>
                                </div>
                            </div>
                        </div>
        ...
        <!-- EVENTS-BAND -->
        <section id="band" class="section-1 single">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 p-0 text">
                        <div class="row intro m-0">
                            <div class="col-12">
                                <span class="pre-title m-0">Saxofonista para eventos</span>
                                <div class="title-icon">                                    
                                    <h2><span class="featured"><span><i class="icon icon-globe-alt"></i>Grupo de música</span></span> - Dúo y Trío</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <h6>Formato adaptable al tipo de evento:</h6>
                                <ul>
                                    <li><b>Dúo Acústico:</b> Una opción elegante e íntima, perfecta para ceremonias, cócteles o recepciones. Ideal para espacios más reducidos y ambientes relajados. Formado por [instrumentos, por ejemplo, saxofón y guitarra/piano].</li>
                                    <li><b>Trío Eléctrico:</b> Ideal para fiestas, banquetes y eventos que requieren mayor energía y dinamismo. Un formato versátil que ofrece un sonido potente y un amplio repertorio. Formado por [instrumentos, por ejemplo, saxofón, guitarra/bajo y batería/percusión].</li>
                                </ul>
                            </div>
                        </div>        
                    </div>
        ...
        <!-- EVENTS-SOLOIST -->
        <section id="solo" class="section-1 single">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 p-0 text">
                        <div class="row intro m-0">
                            <div class="col-12">
                                <span class="pre-title m-0">Saxofonista para eventos</span>
                                <div class="title-icon">                                    
                                    <h2><span class="featured"><span><i class="icon icon-globe-alt"></i>Músico</span></span> Solista</h2>
                                </div>
                            </div>
                        </div>
