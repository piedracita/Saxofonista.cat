...
<html lang="es">
    ...
    <head>
        ...
        <!-- CANONICAL -->
	    <link rel="canonical" href="https://www.saxofonista.cat/videos.php">

        <!-- COMMON-LOCALIZATION -->
        <?php include "common-php/localization/main.html"; ?>
        <!-- /COMMON-LOCALIZATION -->

        <title>Videos | Saxofonista para bodas | Contratar Saxo Profesional | SAXCAT</title>

        <meta name="description" content="Videos de Saxofonista para bodas, grabados en Barcelona, Madrid y lugares únicos de España.">
        <meta name="keywords" content="saxo, saxofonista, videos, bodas, barcelona, madrid, españa">
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <div class="slide-content row text-center">
                            <div class="col-12 mx-auto inner">
                                ...
                                <h1 class="mb-0 title effect-static-text">Saxo para eventos y bodas </h1>
                                <p>Videos de los mejores saxofonistas para bodas y eventos, disponibles para contratación, en estilo moderno o jazz, actuando como solistas, junto al DJ en formato DJ SAXO y en grupo de música para aportar música en directo en tu boda o evento.</p>
                            </div>
                        </div>
                    </div>
